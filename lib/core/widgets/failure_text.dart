...
String _dbValidationMessage(AppLocalizations l10n, String raw) {
  ...
  return switch (code) {
    ...
    'plan_controlled' => l10n.errPlanControlled,
    'fee_charge_locked' => l10n.errFeeChargeLocked,
    'statement_settled' => l10n.errStatementSettled,
    'invalid_kind' => l10n.errInvalidKind,
