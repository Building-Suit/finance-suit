...
class _GlobalAddSheetState extends State<GlobalAddSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      top: false,
      // Compact mode: rows sit on the accessible 48dp floor (the theme's
      // vertical tile padding would add 16dp per row otherwise), so the
      // sheet fits noticeably more destinations per screen.
