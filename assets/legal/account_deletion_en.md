...
- The app securely asks the Finance Suit server to delete the authenticated account. Never send your password to support.

Successful in-app deletion is immediate for the active account and product database. The app then removes its local authenticated session and locally stored preferences from that device.

## Request deletion without the app

Send an email to {{PRIVACY_EMAIL}} from the address registered to your Finance Suit account. Use the subject "Finance Suit account deletion" and state that you want the account deleted. Do not send your password or financial records.
...
Deletion cannot be undone. To use Finance Suit again, you must register a new account and re-enter your information. Deleting the app from your device does not delete the server account; use the in-app deletion flow or contact {{PRIVACY_EMAIL}}.
